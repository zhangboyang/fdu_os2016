...
/*
 * LEAF and NESTED have no difference in recent GCC compilers,
 * so we could just use BEGIN(symbol) to define a function entry.
 */

#define BEGIN(function)		LEAF(function)
